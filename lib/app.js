...
App.bootstrap = function (app, root) {
  ...
  app.before('setup', function (instance, options, done) {
    var preboots = typeof app.given.preboots === 'function'
      ? app.given.preboots
      : builtins.require(app.paths.preboots);
    ...
    preboots(app, options, function (err) {
      ...
      var middlewares = typeof app.given.middlewares === 'function'
        ? app.given.middlewares
        : builtins.require(app.paths.middlewares);

      var routes = typeof app.given.routes === 'function'
        ? app.given.routes
        : builtins.require(app.paths.routes);
